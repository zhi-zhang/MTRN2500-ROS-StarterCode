...
: ${AMENT_CURRENT_PREFIX:="/home/mtrn2500/assignment1/MTRN2500-ROS-StarterCode/install/ci-example"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ci-example/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ci-example/environment/path.sh"
